...
<body>
    ...
    <a href="${pageContext.request.contextPath}/viewCart.jsp">View Cart</a>
    <table border="1">
        <tr>
            <th>ID</th>
            <th>Name</th>
        ...
        <c:forEach var="product" items="${products}">
            <tr>
                ...
                <td>${product.stock}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/view.jsp/${product.id}">View</a>
                    <a href="${pageContext.request.contextPath}/addCart.jsp/${addCartProducts.id}">Add to Cart</a>
